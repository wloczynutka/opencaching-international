...
class User extends BaseUser
{
    ...
    /**
     * @ORM\OneToMany(targetEntity="GeoCacheLog", mappedBy="author")
     */
    protected $logsEntered;
     ...
     * Add logsEntered
     *
     * @param \Oc\CoreBundle\Entity\GeoCacheLog $logsEntered
     * @return User
     */
    public function addLogsEntered(\Oc\CoreBundle\Entity\GeoCacheLog $logsEntered)
    {
        $this->logsEntered[] = $logsEntered;
     ...
     * @param \Oc\CoreBundle\Entity\GeoCacheLog $logsEntered
     */
    public function removeLogsEntered(\Oc\CoreBundle\Entity\GeoCacheLog $logsEntered)
    {
        $this->logsEntered->removeElement($logsEntered);
    }
     ...
     * @return \Doctrine\Common\Collections\Collection 
     */
    public function getLogsEntered()
    {
