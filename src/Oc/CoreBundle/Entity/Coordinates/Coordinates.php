...
class Coordinates
{
	...
	/**
	 * returns latitude as string. Result is in format selecdted by param $format. If param $format is not given, result is in default format.
	 *
	 * @param integer $format (optional) must be one of this class constants: COORDINATES_FORMAT_DECIMAL or COORDINATES_FORMAT_DEG_MIN or COORDINATES_FORMAT_DEG_MIN_SEC
	 * @return string
	 *
	 * example of use:
